 ...
 */
object PetRepo {
    fun getPetCollection(): List<PetCollection> = petCollections
...
val petCollections = listOf(
    PetCollection(
        ...
        name = "Dogs",
        pets = listOf(
            Pet(0, "Sandy", "The Afador is a mixed breed dog–a cross between the Afghan Hound and Labrador Retriever dog breeds. Loyal, energetic, and affectionate, Afadors make excellent family pets, although they do better with older children.",
                R.drawable.afador,"Contact: Animals Matter To Me NGO, Mumbai","Afador","The most common Afador colors include black, brown, gray, red, and fawn.\n" +
            ...
            Pet(1, "Matt", "The Beaglier is a mixed breed dog, a cross between the Beagle and Cavalier King Charles Spaniel dog breeds. Compact, energetic, and loyal, these adorable pups make great family additions for active singles or families with older children.",
                R.drawable.beaglier,"Contact: PAWS, New Delhi","Beaglier", "The main colors of Beagliers are combinations of brown, black, white, and cream. Sometimes their coats are solid, but usually they're a combination of these colors.\n" +
            ...
            Pet(2, "Brownie", "The breed originated in England, the Bulldog is a medium-size dog with a thick-set, low-slung body. The Bulldog was originally used to drive cattle to market and to compete in a bloody sport called bullbaiting. Today, they’re gentle companions who love kids.",
                R.drawable.bulldog,"Contact: Pet Lovers Society, Bangalore","Bulldog", "Bulldogs can be stubborn and lazy. Your mature Bulldog may not be very enthusiastic about going to a walk, but it's important that he is exercised every day to keep him fit.\n" +
            ...
            Pet(3, "Chetak", "Loving, devoted, and energetic, Goldador mixed breed dogs are prized for their good-natured trainability. As a cross between the Golden Retriever and Labrador Retriever, this mix inherited some of the best traits from both purebred parents.",
                R.drawable.goldador,"Contact: Dog Temple, Goa","Goldador", "Goldadors like to eat and can easily become overweight if they don't get enough exercise.\n" +
    ...
    PetCollection(
        ...
        name = "Cats",
        pets = listOf(
            Pet(4, "Pinky", "The Munchkin cat is a relatively new breed of cat characterized by its very short legs. These cute, curious cats are known for snatching shiny objects, so don’t be surprised if you find your favorite piece of jewelry missing:)",
                R.drawable.munchkin,"Contact: Contact: Pet Lovers Society, Bangalore","Munchkin", " The Munchkin is considered to be the original breed of dwarf cat. It is a small to medium-sized cat with a moderate body type and medium-plush coat.The Munchkin comes in all coat colors and patterns." +
            ...
            Pet(5, "Purr", "The Himalayans are wonderful indoor cat companions, gentle, calm, and sweet-tempered. Himalayans have low exercise needs, but they are extremely playful and will get into mischief if they become bored.",
                R.drawable.himalayan,"Contact: Charlie's Animal Rescue Centre (CARE), Ahmedabad","Himalayan", "\n" + "You can keep them entertained and engaged by providing plenty of cat toys and dedicating a few minutes to playtime each day. " +
                        "Because Himalayans have such playful personalities, something as simple as a ball of paper will keep them entertained for hours.\n"+
                        "The Himalayan (a.k.a. Himalayan Persian, or Colourpoint Persian as it is commonly referred to in Europe), is a breed or sub-breed of long-haired cat similar in type to the Persian, " +
                        "with the exception of its blue eyes and its point colouration, which were derived from crossing the Persian with the Siamese. " +
                        "Some registries may classify the Himalayan as a long-haired sub-breed of Siamese, or a colorpoint sub-breed of Persian. The World Cat Federation has merged them with the Colorpoint Shorthair and Javanese into a single breed, the Colorpoint. Like Persians more generally, the Himalayan tends to have a round (cobby) body with short legs, " +
                        "which makes it harder for them to jump as high as other cats do. The bulk of the fur on the body of a Himalayan is white or cream, " +
                        "but the points come in many different colors: Seal (or Black), Blue, Lilac, Chocolate, Red (Flame), and Cream. The points can also be Tabby, Lynx, or Tortoiseshell-patterned."),
        )
    )
)
